...
console.log(userId)
let existingData = JSON.parse(localStorage.getItem(paramId)) || { userData: {} };
...
subbtn.addEventListener("click", (e) => {
    ...
    e.preventDefault();
    if (fname.value === "" || lname.value === "" || eml.value === "" || sal.value === "" || SalDate.value === "") {
    ...
    function updateUser(findData)
    {
        ...
        // console.log(existingUserData.firstname)
...
function addUpdate() {
    ...
    let existingEmailIndex = Object.values(findData).findIndex((userData) => userData.email === eml.value);
    ...
    localStorage.setItem(paramId, JSON.stringify({ ...existingData, userData: findData }));
}
